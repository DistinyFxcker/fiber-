...
func newUser(db *gorm.DB) user {
	...
	_user.PrimaryDomainId = field.NewString(tableName, "primary_domain_id")
	_user.Email = field.NewString(tableName, "email")
	_user.State = field.NewInt(tableName, "state")
	_user.LastTime = field.NewInt64(tableName, "last_time")
	_user.UserGroup = field.NewString(tableName, "user_group")
...
func (u *user) updateTableName(table string) *user {
	...
	u.PrimaryDomainId = field.NewString(table, "primary_domain_id")
	u.Email = field.NewString(table, "email")
	u.State = field.NewInt(table, "state")
	u.LastTime = field.NewInt64(table, "last_time")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["primary_domain_id"] = u.PrimaryDomainId
	u.fieldMap["email"] = u.Email
	u.fieldMap["state"] = u.State
	u.fieldMap["last_time"] = u.LastTime
