...
func newAddress(db *gorm.DB) address {
	...
	_address.ParentId = field.NewString(tableName, "parent_id")
	_address.CityCode = field.NewString(tableName, "city_code")
	_address.Name = field.NewString(tableName, "name")
	_address.Level = field.NewInt(tableName, "level")
	_address.CreatedAt = field.NewInt64(tableName, "created_at")
	_address.UpdatedAt = field.NewInt64(tableName, "updated_at")
