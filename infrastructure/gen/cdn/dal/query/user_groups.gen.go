...
func newUserGroup(db *gorm.DB) userGroup {
	...
	_userGroup.IsDefault = field.NewInt(tableName, "is_default")
	_userGroup.RegionSwitch = field.NewInt(tableName, "region_switch")
...
func (u *userGroup) updateTableName(table string) *userGroup {
	...
	u.IsDefault = field.NewInt(table, "is_default")
	u.RegionSwitch = field.NewInt(table, "region_switch")
...
func (u *userGroup) fillFieldMap() {
	...
	u.fieldMap["region_switch"] = u.RegionSwitch
